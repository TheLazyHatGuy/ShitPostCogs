...
class ShitPosts():
    ...
    async def bee(self, part: int):
        ...
        if part == 1:
            ...
            BeeScript = discord.Embed(description=Bee1, colour=discord.Colour(value=randomcolor()), title="Bee Movie Pt.1")
        elif part == 2:
            ...
            BeeScript = discord.Embed(description=Bee2, colour=discord.Colour(value=randomcolor()), title="Bee Movie Pt.2")
        else:
